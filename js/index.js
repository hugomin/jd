...
console.log(xnow)
 for(var i=0;i<num.length;i++)
    ...
    //like  
    var like=$(".like")[0];
    var likehx=$(".hx",like)[0];
    hover(like,likeover,likeout)
    function likeover(){
      likehx.style.right=1210+"px";
      animate(likehx,{right:-1})
    }
    function likeout(){
      return;  
    }
    ...
    hyp.onclick=function(){
      ...
      {
        liker[i].style.display="none";
      }
      liker[likenow].style.display="block"
    }
})
